...
## Example Files
	...
	sample_depth=folder containing depth file generated from mapping reads to chromosome II, III and IV of T.gondii VEG genome sequence named sample_VEG_genome_GCDP.depth 
	...
	## Cleaning up files
	 ...
	 $ sh chromosome_splitter.sh chromosome_list.txt VEG_genome_GCDP.depth
